...
Push.prototype.then = function (resolve, reject) {
  return this._sendDeferred.then(resolve, reject)
}

Push.prototype.catch = function (reject) {
  return this._sendDeferred.catch(reject)
}

Push.prototype._send = function () {
  var self = this
  var stream = this.res.push(this.path, {
...
Push.prototype._handleCompression = function () {
  ...
  // below threshold
  if (typeof this.length === 'number' && this.length < this.threshold) {
    this.compress = false
    return
  }
